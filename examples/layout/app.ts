import { GeomGraph, SugiyamaLayoutSettings, LayeredLayout, CancelToken } from 'msagl-js';

// Missing export
import { Size } from 'msagl-js/dist/layoutPlatform/math/geometry/rectangle';
...
async function main() {
  const resp = await fetch('https://gist.githubusercontent.com/mohdsanadzakirizvi/6fc325042ce110e1afc1a7124d087130/raw/ab9a310cfc2003f26131a7149950947645391e28/got_social_graph.json');
