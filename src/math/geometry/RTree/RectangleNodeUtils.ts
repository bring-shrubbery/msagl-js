...
export function CrossRectangleNodes<TA, TB, P>(
  a: RectangleNode<TA, P>,
  b: RectangleNode<TB, P>,
  action: (u: TA, v: TB) => void,
) {
...
export function CrossRectangleNodesSameType<T, P>(
  a: RectangleNode<T, P>,
  b: RectangleNode<T, P>,
  action: (u: T, v: T) => void,
) {
...
function FindIntersectionWithProperty<T, P>(
  a: RectangleNode<T, P>,
  b: RectangleNode<T, P>,
...
function HandleEqualityCheck<T, P>(
  a: RectangleNode<T, P>,
  func: (u: T, v: T) => boolean,
): boolean {
