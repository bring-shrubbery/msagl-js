...
export class Parallelogram {
  ...
  static ParallelSegsIntersect(p0: Parallelogram, p1: Parallelogram): boolean {
    ...
    return !(
      r3 < r0 - GeomConstants.distanceEpsilon ||
      r2 > r1 + GeomConstants.distanceEpsilon
    )
  }
  ...
  static parallelogramByCornerSideSide(
    corner: Point,
    sideA: Point,
    sideB: Point,
  ): Parallelogram {
