...
export class EdgeTracer {
  ...
  FindPiercedTriangle(v: RBNode<CdtFrontElement>) {
    ...
    for (let i: number = 1; (i <= 2); i++) {
      ...
      let signedArea0 = RealNumberSpan.sign(Point.signedDoubledTriangleArea(ei.lowerSite.point, this.a.point, this.b.point));
      let signedArea1 = RealNumberSpan.sign(Point.signedDoubledTriangleArea(ei.upperSite.point, this.a.point, this.b.point));
