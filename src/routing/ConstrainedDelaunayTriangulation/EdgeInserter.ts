...
export class EdgeInserter {
  ...
  TriangulatePolygon0(
    polygon: Array<CdtSite>,
    a: CdtSite,
    b: CdtSite,
    reverseTrangleWhenCompare: boolean,
  ) {
    if (polygon.length > 0) {
      this.TriangulatePolygon1(
        0,
        polygon.length - 1,
        polygon,
        a,
        b,
        reverseTrangleWhenCompare,
      )
    }
  }
  ...
  static LocalInCircle(
    ...
    return reverseTrangleWhenCompare
      ? InCircle(v, a, c, b)
      : InCircle(v, a, b, c)
  }
