...
/* abstract */ class VisibilityGraphGenerator {
    ...
    ///  </summary>
    private /* internal */ get VisibilityGraph(): VisibilityGraph {
    }
    private /* internal */ set VisibilityGraph(value: VisibilityGraph)  {
    }
    
    protected constructor (wantReflections: boolean) {
        this.ScanDirection = this.ScanDirection.HorizontalInstance;
        this.eventQueue = new EventQueue();
        this.HorizontalScanSegments = new ScanSegmentTree(this.ScanDirection.HorizontalInstance);
        this.VerticalScanSegments = new ScanSegmentTree(this.ScanDirection.VerticalInstance);
    ...
    private /* internal */ HorizontalScanSegments: ScanSegmentTree;
    
    private /* internal */ VerticalScanSegments: ScanSegmentTree;
    
    protected get ParallelScanSegments(): ScanSegmentTree {
        return this.HorizontalScanSegments;
    ...
    protected get PerpendicularScanSegments(): ScanSegmentTree {
        return this.VerticalScanSegments;
        // TODO: Warning!!!, inline IF is not supported ?
        ScanDirection.IsHorizontal;
    ...
    private /* internal */ ObstacleTree: ObstacleTree = new ObstacleTree();
    ...
    private /* internal */ /* const */ static SentinelOffset: number = 1;
    ...
    private /* internal */ static NewVisibilityGraph(): VisibilityGraph {
        return [][
                VertexFactory,
                =,
                () => {  },
