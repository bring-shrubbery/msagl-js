...
export class NetworkEdge {
  ...
  get source() { return this.iedge.source }
  get target() { return this.iedge.target }

  get separation() { return this.iedge.separation }
  get crossingWeight() { return this.iedge.crossingWeight }
  get weight() { return this.iedge.weight }
}
