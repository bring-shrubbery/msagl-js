...
namespace Microsoft.Msagl.Layout.Layered {
     class AdjacentSwapsWithConstraints {
        ...
        bool CanSwap(number i, number j) {
        ...
        private bool SIsCorrect(number i)
        {
            var s = S[i];
        ...
        private bool UAndVAreOnSameLayer(number u, number v)
        {
            return layering[u] == layering[v];
        }

        private bool UIsToTheLeftOfV(number u, number v)
        {
            return X[u] < X[v];
        }
    }
