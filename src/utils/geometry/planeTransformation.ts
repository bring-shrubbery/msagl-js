...
export class PlaneTransformation {
 ...
 // returns the inversed matrix
    Inverse() {
        ...
        let a00 = this.getElem(1, 1) / det;
        let a01 = -this.getElem(0, 1) / det;
        let a10 = -this.getElem(1, 0) / det;
        let a11 = this.getElem(0, 0) / det;
        let a02 = -a00 * this.getElem(0, 2) - a01 * this.getElem(1, 2);
        let a12 = -a10 * this.getElem(0, 2) - a11 * this.getElem(1, 2);
