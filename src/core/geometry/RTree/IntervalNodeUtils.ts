...
namespace Microsoft.Msagl.Core.Geometry {
     sealed class IntervalNodeUtils {
         static  CrossIntervalNodes<TA, TB>(IntervalNode<TA> a, IntervalNode<TB> b, Action<TA, TB> action) {
         ...
         static  CrossIntervalNodes<TA>(IntervalNode<TA> a, IntervalNode<TA> b, Action<TA, TA> action) {
            if (!a.interval.Intersects(b.interval))
                return;
            if (Equals(a, b))
        ...
        // returns true if "property" holds for some pair
         static bool FindIntersectionWithProperty<TA>(IntervalNode<TA> a, IntervalNode<TA> b, Func<TA, TA, bool> property) {
            if (!a.interval.Intersects(b.interval))
                return false;
            if (Equals(a, b))
        ...
        static  HandleEquality<TA>(IntervalNode<TA> a, Action<TA, TA> action) {
