...
namespace Microsoft.Msagl.Core.Geometry {
     sealed class RectangleNodeUtils {
         static  CrossRectangleNodes<TA, TB>(RectangleNode<TA> a, RectangleNode<TB> b, Action<TA, TB> action) {
         ...
         static  CrossRectangleNodes<TA>(RectangleNode<TA> a, RectangleNode<TA> b, Action<TA, TA> action) {
            if (!a.rectangle.Intersects(b.rectangle))
                return;
            if (Equals(a, b))
        ...
        // returns true if "property" holds for some pair
         static bool FindIntersectionWithProperty<TA>(RectangleNode<TA> a, RectangleNode<TA> b, Func<TA, TA, bool> property) {
            if (!a.rectangle.Intersects(b.rectangle))
                return false;
            if (Equals(a, b))
        ...
        static  HandleEquality<TA>(RectangleNode<TA> a, Action<TA, TA> action) {
